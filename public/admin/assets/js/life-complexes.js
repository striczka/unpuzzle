new Vue({
    ...
    methods: {
        ...
        getComplexes:function(href){
            var vue = this;
            $.get(!!href ? href : "/dashboard/life-complexes", {"_token": this.token}).done(function(complexes){
        ...
        updateComplex: function(){
            var vue = this;
            $.post("/dashboard/life-complexes/" + this.complex.id,
                {
                    "_token": this.token,
                    "_method": "PUT",
                    "name": this.complex.name,
        ...
        deleteComplex: function (complex, event) {
            ...
            if(confirm("Вы действительно хотите удалить этот комплекс?")){
                var vue = this;
                $.post("/dashboard/life-complexes/" + complex.id, {"_token": this.token, "_method": "delete"}).done(function(){
