...
function initRating(){$('.rating_1').rating({fx:'full',image:'/frontend/images/stars2.png',loader:'/frontend/images/ajax-loader.gif',url:'/rate',readOnly:true,callback:function(responce){this.vote_success.fadeOut(2000);}});$('.rating_2').each(function(){var self=$(this);self.rating({fx:'full',image:'/frontend/images/hover-stars.png',loader:'/frontend/images/ajax-loader.gif',url:'/rate',readOnly:true,callback:function(responce){this.vote_success.fadeOut(2000);}});})}(function($){$(function(){$(function(){initRating();});$(document).ready(function(){$('.modal-trigger').leanModal();
    $('.collapsible').collapsible({accordion:false});var glide=$('.slider2').glide().data('api_glide');$('.slider2').glide({autoplay:10000});$(".slider2").css("display","block");$('select').material_select();$('ul.tabs').tabs();});$('.button-collapse').sideNav({menuWidth:300});
    //$(window).on('keyup',function(key){if(key.keyCode===13){glide.jump(3,console.log('Wooo!'));};});
    $('.slider-arrow').on('click',function(){console.log(glide.current());});new WOW().init();
    ...
    //    var speed=500,$scrollTop=$('<a href="#" class="scrollTop">').appendTo('body');
    //    $scrollTop.click(function(e){e.preventDefault();
    ...
    $('.vertical-crousel').slick({infinite:false,vertical:true,slidesToShow:4,slidesToScroll:1,dots:false,responsive:[{breakpoint:1155,settings:{slidesToShow:3,slidesToScroll:1}}]});
    $('.related-products').slick({dots:true,speed:300,slidesToShow:4,slidesToScroll:4,autoplay:true,autoplaySpeed:2000,responsive:[{breakpoint:1200,settings:{slidesToShow:3,slidesToScroll:3,infinite:true,dots:true}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]}
    );});})(jQuery);