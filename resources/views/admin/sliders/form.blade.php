...
<script type="text/javascript">
    tinymce.init({
        ...
        font_formats: "AAvanteBs=AAvanteBs;AvenirPro Bold=AvenirNextLTProBold;Muli Italic=MuliItalic;" +
        "Muli Light=MuliLight;Muli Light Italic=MuliLightItalic;"+
        "Muli Regular=MuliRegular;MyriadPro=myriadpro",
        fontsize_formats: "18px 36px 49px 68px",
...
<div class="col-lg-8">
    ...
    <div class="form-group">
        ...
        {!! Form::textarea('caption',$value = null,['placeholder'=>'Описание','class'=>'form-control tiny']) !!}
    </div>
    <div class="form-group">
